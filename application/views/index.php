...
<table class="procut_item" border="0" cellpadding="4">
  <tr>
    ...
    <input class="dw_button" type="submit" name="submitbutt" value="Buy (225.00 <?php echo $this->config->item('PPL_CURRENCY_CODE'); ?>)" />
    </form>
    </td>
  </tr>
</table>
...
<table class="procut_item" border="0" cellpadding="4">
  <tr>
    ...
    <input class="dw_button" type="submit" name="submitbutt" value="Buy (109.99 <?php echo $this->config->item('PPL_CURRENCY_CODE') ?>)" />
    </form></td>
  </tr>
</table>
</div>
